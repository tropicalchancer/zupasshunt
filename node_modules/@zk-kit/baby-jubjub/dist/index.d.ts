...
type Point<N = BigNumber> = [N, N];

/**
 * Constants and curve parameters for BabyJubJub elliptic curve operations.
 * See: {@link https://eips.ethereum.org/EIPS/eip-2494}
 */
declare const r: bigint;
declare const Fr: F1Field;
declare const Base8: Point<bigint>;
declare const order: bigint;
declare const subOrder: bigint;
/**
 ...
 */
declare function addPoint(p1: Point<bigint>, p2: Point<bigint>): Point<bigint>;
/**
 ...
 */
declare function mulPointEscalar(base: Point<bigint>, e: bigint): Point<bigint>;
/**
 ...
 */
declare function inCurve(p: Point): boolean;
/**
 ...
 */
declare function packPoint(unpackedPoint: Point<bigint>): bigint;
/**
 ...
 */
declare function unpackPoint(packedPoint: bigint): Point<bigint> | null;

export { Base8, Fr, type Point, addPoint, inCurve, mulPointEscalar, order, packPoint, r, subOrder, unpackPoint };
