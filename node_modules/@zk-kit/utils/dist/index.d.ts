 ...
 */
/** @internal */
declare const supportedTypes: readonly ["number", "boolean", "string", "function", "Array", "Uint8Array", "Buffer", "object", "bigint", "stringified-bigint", "hexadecimal", "bignumber", "bignumberish"];
...
declare const typeChecks_isBoolean: typeof isBoolean;
 ...
 * @param parameterName The parameter name.
 */
declare function requireBoolean(parameterValue: boolean, parameterName: string): void;
/**
...
declare const errorHandlers_requireBoolean: typeof requireBoolean;
...
declare const proofPacking_packFflonkProof: typeof packFflonkProof;
declare const proofPacking_packGroth16Proof: typeof packGroth16Proof;
declare const proofPacking_packPlonkProof: typeof packPlonkProof;
declare const proofPacking_unpackFflonkProof: typeof unpackFflonkProof;
declare const proofPacking_unpackGroth16Proof: typeof unpackGroth16Proof;
declare const proofPacking_unpackPlonkProof: typeof unpackPlonkProof;
declare namespace proofPacking {
  export { proofPacking_packFflonkProof as packFflonkProof, proofPacking_packGroth16Proof as packGroth16Proof, proofPacking_packPlonkProof as packPlonkProof, proofPacking_unpackFflonkProof as unpackFflonkProof, proofPacking_unpackGroth16Proof as unpackGroth16Proof, proofPacking_unpackPlonkProof as unpackPlonkProof };
}
...
export { type BigNumber, type BigNumberish, F1Field, type PackedFflonkProof, type PackedGroth16Proof, type PackedPlonkProof, type SupportedType, base64ToBuffer, base64ToText, beBigIntToBuffer, beBufferToBigInt, bigIntToBuffer, bigIntToHexadecimal, bigNumberishToBigInt, bigNumberishToBuffer, bufferToBase64, bufferToBigInt, bufferToHexadecimal, conversions, crypto_node as crypto, errorHandlers, hexadecimalToBigInt, hexadecimalToBuffer, isArray, isBigInt, isBigNumber, isBigNumberish, isBoolean, isBuffer, isDefined, isFunction, isHexadecimal, isNumber, isObject, isString, isStringifiedBigInt, isSupportedType, isType, isUint8Array, leBigIntToBuffer, leBufferToBigInt, packFflonkProof, packGroth16Proof, packPlonkProof, proofPacking as packing, requireArray, requireBigInt, requireBigNumber, requireBigNumberish, requireBoolean, requireBuffer, requireDefined, requireFunction, requireHexadecimal, requireNumber, requireObject, requireString, requireStringifiedBigInt, requireTypes, requireUint8Array, scalar, supportedTypes, textToBase64, typeChecks, unpackFflonkProof, unpackGroth16Proof, unpackPlonkProof };
