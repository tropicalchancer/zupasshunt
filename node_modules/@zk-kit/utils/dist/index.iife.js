...
*/
var zkKitUtils = (function (exports, utils) {
  'use strict';
  ...
  function packFflonkProof(proof) {
      return [
          utils.zeroPadValue(utils.toBeHex(utils.toBigInt(proof.polynomials.C1[0])), 32),
          utils.zeroPadValue(utils.toBeHex(utils.toBigInt(proof.polynomials.C1[1])), 32),
          utils.zeroPadValue(utils.toBeHex(utils.toBigInt(proof.polynomials.C2[0])), 32),
          utils.zeroPadValue(utils.toBeHex(utils.toBigInt(proof.polynomials.C2[1])), 32),
          utils.zeroPadValue(utils.toBeHex(utils.toBigInt(proof.polynomials.W1[0])), 32),
          utils.zeroPadValue(utils.toBeHex(utils.toBigInt(proof.polynomials.W1[1])), 32),
          utils.zeroPadValue(utils.toBeHex(utils.toBigInt(proof.polynomials.W2[0])), 32),
          utils.zeroPadValue(utils.toBeHex(utils.toBigInt(proof.polynomials.W2[1])), 32),
          utils.zeroPadValue(utils.toBeHex(utils.toBigInt(proof.evaluations.ql)), 32),
          utils.zeroPadValue(utils.toBeHex(utils.toBigInt(proof.evaluations.qr)), 32),
          utils.zeroPadValue(utils.toBeHex(utils.toBigInt(proof.evaluations.qm)), 32),
          utils.zeroPadValue(utils.toBeHex(utils.toBigInt(proof.evaluations.qo)), 32),
          utils.zeroPadValue(utils.toBeHex(utils.toBigInt(proof.evaluations.qc)), 32),
          utils.zeroPadValue(utils.toBeHex(utils.toBigInt(proof.evaluations.s1)), 32),
          utils.zeroPadValue(utils.toBeHex(utils.toBigInt(proof.evaluations.s2)), 32),
          utils.zeroPadValue(utils.toBeHex(utils.toBigInt(proof.evaluations.s3)), 32),
          utils.zeroPadValue(utils.toBeHex(utils.toBigInt(proof.evaluations.a)), 32),
          utils.zeroPadValue(utils.toBeHex(utils.toBigInt(proof.evaluations.b)), 32),
          utils.zeroPadValue(utils.toBeHex(utils.toBigInt(proof.evaluations.c)), 32),
          utils.zeroPadValue(utils.toBeHex(utils.toBigInt(proof.evaluations.z)), 32),
          utils.zeroPadValue(utils.toBeHex(utils.toBigInt(proof.evaluations.zw)), 32),
          utils.zeroPadValue(utils.toBeHex(utils.toBigInt(proof.evaluations.t1w)), 32),
          utils.zeroPadValue(utils.toBeHex(utils.toBigInt(proof.evaluations.t2w)), 32),
          utils.zeroPadValue(utils.toBeHex(utils.toBigInt(proof.evaluations.inv)), 32)
      ];
  }
  /**
  ...
  function unpackFflonkProof(proof) {
      return {
          polynomials: {
              C1: [utils.toBigInt(proof[0]).toString(), utils.toBigInt(proof[1]).toString()],
              C2: [utils.toBigInt(proof[2]).toString(), utils.toBigInt(proof[3]).toString()],
              W1: [utils.toBigInt(proof[4]).toString(), utils.toBigInt(proof[5]).toString()],
              W2: [utils.toBigInt(proof[6]).toString(), utils.toBigInt(proof[7]).toString()]
          },
          evaluations: {
              ql: utils.toBigInt(proof[8]).toString(),
              qr: utils.toBigInt(proof[9]).toString(),
              qm: utils.toBigInt(proof[10]).toString(),
              qo: utils.toBigInt(proof[11]).toString(),
              qc: utils.toBigInt(proof[12]).toString(),
              s1: utils.toBigInt(proof[13]).toString(),
              s2: utils.toBigInt(proof[14]).toString(),
              s3: utils.toBigInt(proof[15]).toString(),
              a: utils.toBigInt(proof[16]).toString(),
              b: utils.toBigInt(proof[17]).toString(),
              c: utils.toBigInt(proof[18]).toString(),
              z: utils.toBigInt(proof[19]).toString(),
              zw: utils.toBigInt(proof[20]).toString(),
              t1w: utils.toBigInt(proof[21]).toString(),
              t2w: utils.toBigInt(proof[22]).toString(),
              inv: utils.toBigInt(proof[23]).toString()
          },
          protocol: "fflonk",
          curve: "bn128"
      };
  ...
  exports.packFflonkProof = packFflonkProof;
  exports.packGroth16Proof = packGroth16Proof;
  exports.packPlonkProof = packPlonkProof;
  ...
  exports.unpackFflonkProof = unpackFflonkProof;
  exports.unpackGroth16Proof = unpackGroth16Proof;
  exports.unpackPlonkProof = unpackPlonkProof;
