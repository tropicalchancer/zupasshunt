import { ConfirmEmailResponseValue } from "../RequestTypes";
 ...
 */
export declare function requestConfirmationEmail(zupassServerUrl: string, email: string, force: boolean): Promise<ConfirmEmailResult>;
export type ConfirmEmailResult = APIResult<ConfirmEmailResponseValue>;
//# sourceMappingURL=requestConfirmationEmail.d.ts.map