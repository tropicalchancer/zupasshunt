...
exports.SubscriptionErrorType = exports.FeedSubscriptionManager = exports.applyActions = exports.ZupassFeedIds = void 0;
...
})(ZupassFeedIds || (exports.ZupassFeedIds = ZupassFeedIds = {}));
/**
 * Applies a set of actions to a PCD collection.
 */
async function applyActions(collection, actions) {
...
class FeedSubscriptionManager {
    constructor(api, providers, activeSubscriptions, errors) {
        this.updatedEmitter = new emitter_1.Emitter();
        this.api = api;
    ...
    validateActions(subscription, actions) {
        ...
        for (const action of actions) {
            if (!(0, pcd_collection_1.matchActionToPermission)(action, grantedPermissions)) {
    ...
    async getHash() {
        return await (0, passport_crypto_1.getHash)(this.serialize());
    }
}
