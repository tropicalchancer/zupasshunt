...
class PCDCrypto {
    static async newInstance(sodium) {
        sodium = sodium ?? (await (0, libsodium_1.getSodium)());
    ...
    cryptoHash(str) {
        return (0, utils_1.arrayBufferToHexString)(this.sodium.crypto_hash(str));
    }
