...
import { EdDSATicketPCD, EdDSATicketPCDTypeName } from "./EdDSATicketPCD.js";
...
export async function deserialize(serialized) {
    ...
    return new EdDSATicketPCD(deserializedWrapper.id, { ticket: deserializedWrapper.ticket }, { eddsaPCD: deserializedEdDSAPCD });
}
 ...
 */
export const EdDSATicketPCDPackage = {
