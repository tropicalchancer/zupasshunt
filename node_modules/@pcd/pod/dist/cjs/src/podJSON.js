...
exports.bigintToSimplestJSON = exports.podValueToJSON = exports.podEntriesToJSON = exports.bigintFromJSON = exports.podValueFromTypedJSON = exports.podValueFromJSON = exports.podEntriesFromJSON = void 0;
...
function podEntriesFromJSON(jsonEntries) {
    (0, podChecks_1.requireType)("jsonEntries", jsonEntries, "object");
    return Object.fromEntries(Object.entries(jsonEntries).map(([name, jsonValue]) => [
        (0, podChecks_1.checkPODName)(name),
        podValueFromJSON(jsonValue, name)
    ]));
}
exports.podEntriesFromJSON = podEntriesFromJSON;
/**
...
exports.podValueFromJSON = podValueFromJSON;
/**
...
function podValueFromTypedJSON(podValueType, jsonRawValue, nameForErrorMessages) {
    ...
    switch (podValueType) {
        case "string":
            return (0, podChecks_1.checkPODValue)(nameForErrorMessages, {
                type: "string",
                value: jsonRawValue // checkPODValue checks this
            });
        case "bytes":
            (0, podChecks_1.requireType)(nameForErrorMessages, jsonRawValue, "string");
            return (0, podChecks_1.checkPODValue)(nameForErrorMessages, {
                type: "bytes",
                value: (0, podUtil_1.decodeBytesRaw)((0, podChecks_1.checkBase64Encoding)(jsonRawValue, `Value ${nameForErrorMessages} must be encoded in base64.`), "base64")
            });
        case "cryptographic":
            return (0, podChecks_1.checkPODValue)(nameForErrorMessages, {
                type: "cryptographic",
...
exports.podValueFromTypedJSON = podValueFromTypedJSON;
/**
...
function podValueToJSON(podValue, nameForErrorMessages) {
    nameForErrorMessages = nameForErrorMessages || "(unnamed)";
    podValue = (0, podChecks_1.checkPODValue)(nameForErrorMessages, podValue);
    switch (podValue.type) {
        case "string":
            return podValue.value;
        case "bytes":
            return { bytes: (0, podUtil_1.encodeBytes)(podValue.value, "base64") };
        case "cryptographic":
...
exports.podValueToJSON = podValueToJSON;
/**
...
exports.bigintToSimplestJSON = bigintToSimplestJSON;
