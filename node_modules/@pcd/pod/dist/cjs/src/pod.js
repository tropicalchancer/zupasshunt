...
const podContent_1 = require("./podContent");
 ...
 */
class POD {
    constructor(content, signature, signerPublicKey) {
     ...
     */
    static sign(entries, signerPrivateKey) {
        const podContent = podContent_1.PODContent.fromEntries(entries);
        const { signature, publicKey } = (0, podCrypto_1.signPODRoot)(podContent.contentID, signerPrivateKey);
     ...
     */
    verifySignature() {
        return (0, podCrypto_1.verifyPODRootSignature)(this._content.contentID, this._signature, this._signerPublicKey);
    }
    /**
     ...
     */
    static load(entries, signature, signerPublicKey) {
        return new POD(podContent_1.PODContent.fromEntries(entries), (0, podChecks_1.checkSignatureFormat)(signature), (0, podChecks_1.checkPublicKeyFormat)(signerPublicKey));
    }
    /**
    ...
    toJSON() {
        return {
            entries: (0, podJSON_1.podEntriesToJSON)(this._content.asEntries()),
     ...
     */
    static fromJSON(jsonPOD) {
        (0, podChecks_1.requireType)("jsonPOD", jsonPOD, "object");
        ...
        if (Object.keys(jsonPOD).length !== 3) {
            throw TypeError("JSON POD should contain only the 3 expected keys: " +
                "entries, signature, signerPublicKey");
        }
        return POD.load((0, podJSON_1.podEntriesFromJSON)(jsonPOD.entries), jsonPOD.signature, jsonPOD.signerPublicKey);
    }
}
exports.POD = POD;
