...
exports.decodeBytesAuto = exports.decodeBytesRaw = exports.encodeBytes = exports.applyOrMap = exports.printPODValueOrTuple = exports.printPODValue = exports.clonePODEntries = exports.cloneOptionalPODValue = exports.clonePODValue = exports.getRequiredPODValueForCircuit = exports.getPODValueForCircuit = void 0;
...
exports.getPODValueForCircuit = getPODValueForCircuit;
/**
...
exports.getRequiredPODValueForCircuit = getRequiredPODValueForCircuit;
/**
...
exports.clonePODValue = clonePODValue;
/**
...
exports.cloneOptionalPODValue = cloneOptionalPODValue;
/**
...
exports.clonePODEntries = clonePODEntries;
/**
...
function printPODValue(podValue) {
    return JSON.stringify(podValue ? (0, podJSON_1.podValueToJSON)(podValue) : undefined);
}
exports.printPODValue = printPODValue;
/**
...
function printPODValueOrTuple(value) {
    return JSON.stringify(value
        ? Array.isArray(value)
            ? value.map((v) => (0, podJSON_1.podValueToJSON)(v))
            : (0, podJSON_1.podValueToJSON)(value)
        : undefined);
}
exports.printPODValueOrTuple = printPODValueOrTuple;
/**
...
exports.decodeBytesRaw = decodeBytesRaw;
/**
...
exports.decodeBytesAuto = decodeBytesAuto;
