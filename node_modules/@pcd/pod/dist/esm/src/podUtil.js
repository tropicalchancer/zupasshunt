import { podValueToJSON } from "./podJSON.js";
/**
 ...
 *   in a circuit
 */
export function getPODValueForCircuit(podValue) {
 ...
 *   in a circuit
 */
export function getRequiredPODValueForCircuit(podValue, nameForErrorMesages) {
 ...
 */
export function clonePODValue(podValue) {
 ...
 */
export function cloneOptionalPODValue(podValue) {
 ...
 */
export function clonePODEntries(entries) {
    const newEntries = {};
 ...
 */
export function printPODValue(podValue) {
 ...
 * @throws if the POD value is malformed
 */
export function printPODValueOrTuple(value) {
 ...
 */
export function applyOrMap(f, input) {
 ...
 *   encoding format
 */
export function decodeBytesRaw(encoded, encoding = "base64") {
 ...
 */
export function decodeBytesAuto(encoded, encodingPattern, encodingGroups, errorMessage) {
