...
import { POD_PRIVATE_KEY_REGEX, POD_PUBLIC_KEY_REGEX, POD_SIGNATURE_REGEX, PUBLIC_KEY_ENCODING_GROUPS, SIGNATURE_ENCODING_GROUPS } from "./podChecks.js";
import { EDDSA_PUBKEY_TYPE_STRING, POD_NULL_HASH } from "./podTypes.js";
 ...
 */
export function podBytesHash(input) {
...
export function decodePrivateKey(privateKey) {
    return decodeBytesAuto(privateKey, POD_PRIVATE_KEY_REGEX, PUBLIC_KEY_ENCODING_GROUPS, "Private key should be 32 bytes, encoded as hex or Base64.");
}
/**
...
export function decodePublicKey(publicKey) {
    const rawPublicKey = unpackPublicKey(leBufferToBigInt(decodeBytesAuto(publicKey, POD_PUBLIC_KEY_REGEX, PUBLIC_KEY_ENCODING_GROUPS, "Public key should be 32 bytes, encoded as hex or Base64.")));
...
export function decodeSignature(encodedSignature) {
    return unpackSignature(decodeBytesAuto(encodedSignature, POD_SIGNATURE_REGEX, SIGNATURE_ENCODING_GROUPS, "Signature should be 64 bytes, encoded as hex or Base64."));
}
/**
 ...
 */
export function deriveSignerPublicKey(privateKey) {
